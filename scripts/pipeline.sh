...
python3 src/training/main.py experiments/baseline_contrive_0.20.cfg

echo "Training baseline model with closs_cntrv0.20 setting"
python3 src/training/main.py experiments/closs_cntrv0.20.cfg

#Train model
echo "Training baseline model with closs_cntrv0.20_fweight0 setting"
python3 src/training/main.py experiments/closs_cntrv0.20_fweight0.0.cfg
